...
project_name = "./runs/train/npy_version_YoDa3ch/no_augment"

# os.system("python train.py --img {} \
# --epochs {} --batch-size {} \
# --data {} \
# --input-ch 7 --target-ch 3 \
# --weights ./runs/train/npy_version/no_augment/scratch_5s/weights/last.pt --hyp {} --cfg yolov5s.yaml \
# --device 0 --exist-ok --patience 0 \
# --name scratch_5s_test --project {}".format(imgsize, epochs, batch_size, data_, hpy_no_aug, project_name))
